...
if (! function_exists('database_encryption')) {
     ...
     */
    function database_encryption(): \Involix\Database\Encryption\EncryptionHelper
    {
...
if (! function_exists('db_encryption')) {
     ...
     * @return \AustinHeap\Database\Encryption\EncryptionHelper
     */
    function db_encryption(): \Involix\Database\Encryption\EncryptionHelper
    {
...
if (! function_exists('dbencryption')) {
     ...
     * @return \AustinHeap\Database\Encryption\EncryptionHelper
     */
    function dbencryption(): \Involix\Database\Encryption\EncryptionHelper
    {
        return database_encryption();
    }
}
